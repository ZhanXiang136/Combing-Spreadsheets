...
def main():
    ...
    df_to_be_added = pd.read_excel('main.xlsx', sheet_name=0)#determine_correct_pandas_conversion(file_to_be_added)
    df_to_add = pd.read_excel('event.xlsx', sheet_name=0)#determine_correct_pandas_conversion(file_to_add)
